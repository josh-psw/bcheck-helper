...
class BCheckStorefrontPanel extends JPanel {
    BCheckStorefrontPanel(StoreController storeController,
        ...
        JPanel previewPanel = new BCheckPreviewPanel(storefrontModel, actionController, burp);

        TablePanelController panelController = new DefaultTablePanelController(storeController);
        JPanel tablePanel = new BCheckTablePanel(
                panelController,
                storefrontModel,
                burp,
                executor,
